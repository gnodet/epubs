...
AUTHOR="F.-J. Thonnard"
ABBR="phi" 
UUID="3de381d5-a71f-4bdf-962a-2bc36abab4dC"
OUTPUT="Precis-Philo.epub"     
...
cd org
if [ ! -e inquisition.ca/fr/livre/thonnard/philo/s991_biblios.htm ]
then
  wget --user-agent="" -r -np http://inquisition.ca/fr/livre/thonnard/philo/s001_index.htm
fi
cd ..
if [ ! -d out ]
then
...
cp ../org/inquisition.ca/fr/livre/thonnard/philo/*.htm .
for FILE in *.htm
do           
...
<svg xmlns="http://www.w3.org/2000/svg" 
	...
	<text style="font-size:72px;font-style:normal;font-weight:bold;fill:#000000;font-family:Brush Script MT" 
		  x="265" y="440">
        <tspan style="text-align:center;text-anchor:middle">phisolophie</tspan>
    </text>
</svg>
EOF
...
<package xmlns="http://www.idpf.org/2007/opf" version="2.0" unique-identifier="uuid_id">
  <metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:opf="http://www.idpf.org/2007/opf" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:calibre="http://calibre.kovidgoyal.net/2009/metadata" xmlns:dc="http://purl.org/dc/elements/1.1/">
    <dc:title>Précis de philosophie</dc:title>
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:html="http://www.w3.org/1999/xhtml" version="1.0">
	...
	<xsl:template match="/">
		<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1" xml:lang="eng">
			...
			<docTitle>
				<text>Pr&#xE9;cis de philosophie</text>
			</docTitle>
			<navMap>
...
EOF
xsltproc ../toc.xsl OEBPS/s002_TDM.htm >toc.ncx
